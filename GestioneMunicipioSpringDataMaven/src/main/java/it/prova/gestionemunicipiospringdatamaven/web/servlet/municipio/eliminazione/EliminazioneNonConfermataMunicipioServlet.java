...
@WebServlet("/EliminazioneNonConfermataMunicipioServlet")
public class EliminazioneNonConfermataMunicipioServlet extends HttpServlet {
    ...
    public EliminazioneNonConfermataMunicipioServlet() {
        super();
    }
